const programVersion = '2024-03-065: 985';
const staticCacheName = 'pwaui-static-985'; 
const dynamicCacheName = 'pwaui-dynamic-985'; // tämäkin joutaisi pois, mutta jätetään toistaiseksi..
...
const assets = [
  ...
  'js/ui.js',
  'js/db.js',
  'js/idb-backup-and-restore.js',
  'js/ui-idb-exportimports.js',
